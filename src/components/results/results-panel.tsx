...
import type { OptimizerProgress, Simulation } from "@/domain/types";
...
import { downloadTextFile } from "@/lib/import-export/csv";
        ...
        <Card>
          <CardContent className="py-4">
            <p className="mb-2 text-sm text-navy-800">
              Calcul en cours… {progress ? `${progress.processedInstances} / ${progress.totalInstances} cartons traités` : ""}
            </p>
            <ProgressBar value={progress ? progress.processedInstances / Math.max(1, progress.totalInstances) : 0} />
          </CardContent>
        </Card>
      )}
